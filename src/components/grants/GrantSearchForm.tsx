						...
						<div className="space-y-2">
							...
							<div className="flex gap-2">
								<Input
									...
									onChange={(e) =>
										handleInputChange('minFunding', e.target.value)
									}
									type="number"
								/>
								<Input
									...
									onChange={(e) =>
										handleInputChange('maxFunding', e.target.value)
									}
									type="number"
								/>
							</div>
						...
						<div className="space-y-2">
							...
							<div className="flex gap-2">
								<Input
									...
									onChange={(e) =>
										handleInputChange('minDeadline', e.target.value)
									}
									type="date"
								/>
								<Input
									...
									onChange={(e) =>
										handleInputChange('maxDeadline', e.target.value)
									}
									type="date"
								/>
							</div>
						...
						<div className="space-y-2">
							...
							<div className="flex gap-2">
								<Input
									...
									onChange={(e) =>
										handleInputChange('minFitScore', e.target.value)
									}
									type="number"
									min="0"
									max="10"
								...
								<Input
									...
									onChange={(e) =>
										handleInputChange('maxFitScore', e.target.value)
									}
									type="number"
									min="0"
									max="10"
