		...
		<div className="container relative flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
			<div className="relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r overflow-hidden">
				...
				<div className="relative z-20 flex items-center">
					<h1 className="text-4xl font-bold tracking-tight">AI GrantMatch</h1>
				</div>

				<div className="relative z-20 mt-auto">
					<blockquote className="space-y-6">
						<p className="text-xl leading-relaxed">
							&ldquo;AI GrantMatch has revolutionized how we find and apply for
							grants. It&apos;s an invaluable tool that has helped us secure
							funding to make a real difference in our community.&rdquo;
						</p>
						<footer className="text-sm">
							<p className="font-semibold">Sofia Davis</p>
							<p className="opacity-80">
								Executive Director - Hope Community Foundation
							</p>
						</footer>
					</blockquote>
				</div>
				...
				<div className="relative mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[350px]">
					<div className="flex flex-col space-y-3 text-center">
						...
						<p className="text-muted-foreground">
							Enter your email to sign in to your account and continue your
							mission
						</p>
					</div>
