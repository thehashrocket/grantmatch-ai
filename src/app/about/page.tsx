			...
			<div className="relative mx-auto max-w-5xl px-4 py-16 md:px-8 md:py-24 space-y-16">
				<header className="text-center space-y-4">
					...
					<p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
						GrantMatch AI connects mission-driven teams with the funding that
						keeps programs alive. We pair high-quality grant data with
						human-centered design so you can spend less time hunting for
						opportunities and more time serving your community.
					</p>
				</header>
				...
				<section className="grid gap-8 md:grid-cols-2">
					<div className="rounded-2xl border border-border/60 bg-white/80 p-8 shadow-sm backdrop-blur dark:bg-gray-950/70">
						...
						<ul className="space-y-3 text-muted-foreground">
							<li>
								<span className="font-medium text-foreground">Nonprofits</span>{' '}
								balancing impact with lean teams who need a smarter shortlist.
							</li>
							<li>
							...
							<li>
								...
								seeking funding for students, educators, and facilities.
							</li>
							<li>
								<span className="font-medium text-foreground">
					...
					<div className="rounded-2xl border border-border/60 bg-white/80 p-8 shadow-sm backdrop-blur dark:bg-gray-950/70">
						...
						<p className="text-muted-foreground mb-4">
							Funding shouldn&apos;t be a maze. GrantMatch AI cuts through the
							noise with:
						</p>
						<ul className="space-y-3 text-muted-foreground">
							<li>
								AI-powered fit scores that surface the best-aligned
								opportunities for your mission.
							</li>
							<li>
								Fresh federal, state, and local data so you never miss a
								deadline.
							</li>
							<li>
								Clear explanations and links that make it easy to share and act
								quickly.
							</li>
							<li>
								A focus on accessibility and collaboration—because winning
								grants is a team sport.
							</li>
						</ul>
					</div>
				</section>
					...
					<div className="grid gap-6 md:grid-cols-2 md:items-center">
						<div className="space-y-3">
							...
							<p className="text-muted-foreground">
								We obsess over clarity and momentum. Every feature we ship—fit
								scoring, deadline tracking, streamlined views—is designed to
								help you reclaim time and move funding forward faster. If
								something slows you down, tell us and we&apos;ll fix it.
							</p>
						</div>
						<div className="rounded-2xl border border-border/60 bg-white/80 p-6 text-muted-foreground shadow-sm backdrop-blur dark:bg-gray-950/80">
							...
							<ul className="space-y-2">
								...
								<li>
									• Confidence you&apos;re tracking every relevant deadline.
								</li>
								<li>
									• A clear story to share with stakeholders and collaborators.
								</li>
							</ul>
						</div>
					</div>
				...
				<section className="text-center space-y-4">
					...
					<p className="text-muted-foreground max-w-2xl mx-auto">
						Jump into the dashboard, explore the latest opportunities, and use
						fit scores to decide where to focus first.
					</p>
