import { Prisma, type Grant } from '@/prisma/generated/client';

export type DetailUpsert = Prisma.GrantDetailUncheckedCreateInput | Prisma.GrantDetailUncheckedUpdateInput;
export type AttachmentCreate = Prisma.GrantAttachmentCreateManyInput;

export type GrantWithRelations = Grant & {
  details?: Prisma.GrantDetail | null;
  attachments?: Prisma.GrantAttachment[];
};
...
export interface GrantDetailFetcher {
  endpoint: string;
  fetch(grant: GrantWithRelations, opts?: { timeoutMs?: number }): Promise<GrantDetailsResult>;
}
