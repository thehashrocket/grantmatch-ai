...
export default async function RootLayout({
	...
	return (
		<html lang="en" className="antialiased">
			<body
				className={`${GeistSans.variable} ${GeistMono.variable} font-sans bg-gradient-to-b from-white to-gray-50/50 dark:from-gray-950 dark:to-gray-900/50 min-h-screen`}
			>
				<NextAuthProvider>
					<TRPCProvider>
						<ErrorBoundary>
										...
										<div className="py-8 text-center">
											<div className="space-y-4">
												...
												<p className="text-sm text-gray-500 dark:text-gray-500">
													© {new Date().getFullYear()} AI GrantMatch -
