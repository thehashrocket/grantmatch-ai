				...
				<div className="relative">
					...
					<div className="text-center space-y-6 relative">
						...
						<p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
							Find and secure the funding you need to make a lasting impact in
							your community
						</p>
					</div>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
					...
					<div className="group relative transform transition-all duration-500 hover:scale-105">
						...
						<div className="relative h-full rounded-2xl border border-gray-200 bg-white/90 p-8 dark:border-gray-800 dark:bg-gray-950/90 backdrop-blur">
							...
							<p className="text-gray-600 dark:text-gray-300">
								AI-powered grant recommendations tailored to your
					...
					<div className="group relative transform transition-all duration-500 hover:scale-105">
						...
						<div className="relative h-full rounded-2xl border border-gray-200 bg-white/90 p-8 dark:border-gray-800 dark:bg-gray-950/90 backdrop-blur">
							...
							<p className="text-gray-600 dark:text-gray-300">
								Simplified grant application process with smart form filling and
								deadline tracking.
							</p>
						</div>
					</div>
					...
					<div className="group relative transform transition-all duration-500 hover:scale-105">
						...
						<div className="relative h-full rounded-2xl border border-gray-200 bg-white/90 p-8 dark:border-gray-800 dark:bg-gray-950/90 backdrop-blur">
							...
							<p className="text-gray-600 dark:text-gray-300">
								Measure and showcase your organization&apos;s impact with
